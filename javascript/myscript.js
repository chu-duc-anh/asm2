...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Hãy đợi load đến 999. Đến 999 thì click vô:" + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Đây là code lập độc quyền bởi:';
document.querySelector('.Description .modal-body').innerHTML = 'Đức Aanh(bún) <i class="fas fa-heart"></i> ';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";

author.innerHTML = "Mọi thắc mắc bạn có thể liên hệ<a href='https://www.facebook.com/buntom.0409/'>Đức Aanh(bún)<a>";
